...
const image = Photos.offerings.super.branding;
    ...
    <Grid size={12} component={Card}>
      <CardContent component={Grid} container>
        ...
        <Grid size={{ xs: 12, lg: 5 }} offset={{ xs: 0, lg: 1 }}>
          <Stack>
            <ListItem>
              <Typography variant="h3">Commercial & Branding Photography</Typography>
            </ListItem>
            <ListItem>
              <NextLink href="/offerings/branding" title="Commercial & Branding Photography">
